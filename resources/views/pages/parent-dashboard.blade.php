            ...
            <div class="row">
              <div class="col-xs-12">
                <div class="col-in row">
                  <div class="col-xs-12">
                    <h4 class="text-center m-t-15 text-primary"><a href="#">Child's Name</a></h3>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="white-box">
            <div class="row">
              <div class="col-xs-12">
                <div class="col-in row">
                  <div class="col-xs-12">
                    <h3 class="counter text-center m-t-15 text-primary"><a href="{{ url('/parent/message/compose')}}">GO</a></h3>
                  </div>
                  <div class="col-xs-12">
