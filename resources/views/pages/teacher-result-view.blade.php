          ...
          <div class="white-box p-l-20 p-r-20">
            <div class="row">
              <dl class="dl-horizontal">
                ...
                <dd><a href="#">Change Profile Pics</a></dd>  <br><br>
          ...
          <div class="white-box p-l-20 p-r-20">
            <div class="row">
              <dl class="dl-horizontal">
                ...
                <dt style="text-align: left; white-space: normal;">Teacher </dt> <dd>{{ $student->classTable($student->class_id)->teacher->fullname }}</dd> <br></br>
          ...
          <div class="white-box p-l-20 p-r-20">
            <div class="row">
              <dl class="dl-horizontal">
                ...
                <dt style="text-align: left; white-space: normal;">Parent Name: </dt> <dd><a href="{{ url('/teacher/parent/profile/'. $student->parent($student->parent_name)->id) }}">{{ $student->parent_name }}</a></dd> <br></br>
