      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="white-box p-l-20 p-r-20">
            <h3 class="box-title m-b-0">Edit Subject</h3>
            @if(count($errors) > 0)
            ...
            <div class="row">
              <div class="col-md-12">
                <form class="form-material form-horizontal" method="post" action="{{url('super-admin/subject/edit')}}">
                  {{csrf_field()}}
                  <input type="hidden" name="id" value="{{$subject->id}}">
                  <div class="form-group">
                    <label class="col-md-12">Name<span class="help"> e.g English Language</span></label>
                    <div class="col-md-12">
                      <input type="text" class="form-control form-control-line" name="name" value="{{$subject->name}}">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-md-12">Short Name<span class="help"> e.g Eng</span></label>
                    <div class="col-md-12">
                      <input type="text" class="form-control form-control-line" name="short_name" value="{{$subject->short_name}}">
                    </div>
                  </div>
