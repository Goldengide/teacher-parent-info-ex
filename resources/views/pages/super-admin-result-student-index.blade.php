  ...
  <div id="page-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="white-box">
            <h3 class="box-title m-b-0"><a class="btn btn-info" href="{{ url('/super-admin/result/student/'.$season->id.'/'.$class->id. '/'.$student->id. '/'. $student->student_name.'.pdf')}}">Download PDF</a></h3>
